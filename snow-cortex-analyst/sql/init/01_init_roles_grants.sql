...
GRANT USAGE, CREATE TABLE
  ON SCHEMA IDENTIFIER($SCHEMA_SEED)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);

GRANT USAGE, CREATE TABLE, CREATE VIEW
  ON SCHEMA IDENTIFIER($SCHEMA_OBT)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);

GRANT USAGE, CREATE TABLE, CREATE VIEW, CREATE SEMANTIC VIEW
  ON SCHEMA IDENTIFIER($SCHEMA_SEMANTIC)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);
...
GRANT CREATE AGENT ON SCHEMA IDENTIFIER($SCHEMA_SEMANTIC)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);

-- Future grants so new tables/views are accessible
GRANT SELECT ON FUTURE TABLES IN SCHEMA IDENTIFIER($SCHEMA_SEED)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);

GRANT SELECT ON FUTURE VIEWS IN SCHEMA IDENTIFIER($SCHEMA_OBT)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);

GRANT SELECT ON FUTURE TABLES IN SCHEMA IDENTIFIER($SCHEMA_OBT)
  TO ROLE IDENTIFIER($DBT_ROLE_NAME);
...
GRANT USAGE ON SCHEMA IDENTIFIER($SCHEMA_SEMANTIC)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);

GRANT SELECT ON FUTURE SEMANTIC VIEWS IN SCHEMA IDENTIFIER($SCHEMA_SEMANTIC)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);

GRANT SELECT ON ALL SEMANTIC VIEWS IN SCHEMA IDENTIFIER($SCHEMA_SEMANTIC)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);
...
GRANT USAGE ON SCHEMA IDENTIFIER($SCHEMA_OBT)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);

GRANT SELECT ON ALL VIEWS IN SCHEMA IDENTIFIER($SCHEMA_OBT)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);
...
GRANT USAGE ON SCHEMA IDENTIFIER($SCHEMA_SEED)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);

GRANT SELECT ON ALL TABLES IN SCHEMA IDENTIFIER($SCHEMA_SEED)
  TO ROLE IDENTIFIER($CORTEX_ROLE_NAME);

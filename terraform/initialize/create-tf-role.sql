...
-- Seems only account admin can create resource monitor and could not find a grant to let other roles to create resource monitor
-- GRANT CREATE RESOURCE MONITOR ON ACCOUNT TO ROLE ENTECHLOG_TERRAFORM_ROLE;

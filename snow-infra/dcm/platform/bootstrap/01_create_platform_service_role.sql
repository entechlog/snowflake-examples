...
-- WITH GRANT OPTION is required so the platform role can re-grant these
-- account-level privileges to per-team roles via DCM. MANAGE GRANTS alone
-- doesn't override the GRANT-OPTION requirement for account privileges.

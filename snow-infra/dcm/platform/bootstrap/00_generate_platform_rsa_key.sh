...
#     statement (so you can re-register the existing key if needed).
...
#   ./platform/bootstrap/00_generate_platform_rsa_key.sh --force
#   ./platform/bootstrap/00_generate_platform_rsa_key.sh --register-via <conn>
# =============================================================================
set -euo pipefail
